...
namespace EmployeeUWPApp
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public XamlUICommand ChangeLastNameCommand = null;
        ...
        private async void ChangeLastNameCommand_ExecuteRequested(XamlUICommand sender, ExecuteRequestedEventArgs args)
        {
            ...
            {
                await SpeakAsync($"Changing Last name, from {_employeesOC[lv.SelectedIndex].LastName}, to, {txtLastName.Text}");
                _employeesOC[lv.SelectedIndex].LastName = txtLastName.Text;
            }
        }
